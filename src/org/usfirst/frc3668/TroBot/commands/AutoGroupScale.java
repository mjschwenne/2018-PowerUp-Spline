...
public class AutoGroupScale extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	addSequential(new AutoTurnGyro(Settings.autoTurnSpeed, 180));
    	addSequential(new AutoDriveProfileGyro(180, Settings.autoCruiseSpeed, Settings.autoLineDistance));
